...
from caliber import HeteroskedasticLinearRegressionModel, LogStdLinearRegressionModel
...
def test_minimizing_regression_models() -> None:
    ...
    models = [
        ...
        LogStdLinearRegressionModel(
            mean_model=linreg_model, minimize_options=dict(x0=np.array([0, 1, 1]))
        ),
    ]
    for model in models:
